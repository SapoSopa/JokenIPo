...
void PlaySound(int soundIdx); // play a sound that could be identified by a index

int LoadSound(const char *fileName); // load sound and save in dynamic array of sounds
int LoadMusic(const char *fileName); // load music and save in dynamic array of musics
